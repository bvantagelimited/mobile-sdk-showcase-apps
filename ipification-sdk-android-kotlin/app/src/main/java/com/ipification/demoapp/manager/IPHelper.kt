...
class IPHelper {
    ...
    companion object Factory {
        ...
        // just for testing. client app need to call to their backend service
        fun callTokenExchangeAPI(activity: Activity, code: String) {
            doPostToken(code, callback = object : TokenCallback {
                override fun onSuccess(response: String) {
                    val phoneNumberVerified =
                        Util.parseUserInfoJSON(response, "phone_number_verified")
