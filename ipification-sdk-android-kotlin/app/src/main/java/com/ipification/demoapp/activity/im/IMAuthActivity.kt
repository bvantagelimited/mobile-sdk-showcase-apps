...
class IMAuthActivity : ComponentActivity() {
    ...
    @Composable
    fun IMAuthenticationScreen(onBackClick: () -> Unit) {
        val context = LocalContext.current
        val activity = context as? IMAuthActivity
        ...
        val isTelegramInstalled = remember { 
            ...
            packageManager.isPackageInstalled(IPConfiguration.getInstance().telegramWebPackageName)
        }
        ...
        Scaffold(
            topBar = {
                IPificationTopBar(
                    title = "IM Authentication - ${BuildConfig.VERSION_NAME}",
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .clickable(enabled = isWhatsAppInstalled) {
                                activity?.callInstantMessageFlow("wa")
                            }
                            .then(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .clickable(enabled = isTelegramInstalled) {
                                activity?.callInstantMessageFlow("telegram")
                            }
                            .then(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .clickable(enabled = isViberInstalled) {
                                activity?.callInstantMessageFlow("viber")
                            }
                            .then(
    ...
    fun callInstantMessageFlow(channel: String) {
