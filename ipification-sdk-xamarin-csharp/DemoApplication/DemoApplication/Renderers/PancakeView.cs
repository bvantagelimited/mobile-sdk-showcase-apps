using System;
using DemoApplication.Styles;
using Xamarin.Forms;

namespace DemoApplication.Renderers
{
    public class PancakeView : ContentView
    {
        ...
        public static readonly BindableProperty BackgroundGradientStopsProperty = BindableProperty.Create(nameof(BackgroundGradientStops), typeof(DemoApplication.Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(DemoApplication.Styles.GradientStopCollection),
        ...
        public static readonly BindableProperty BorderGradientStopsProperty = BindableProperty.Create(nameof(BorderGradientStops), typeof(DemoApplication.Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(DemoApplication.Styles.GradientStopCollection),
        defaultValueCreator: bindable =>
        {
            return new DemoApplication.Styles.GradientStopCollection();
        });
        ...
        public DemoApplication.Styles.GradientStopCollection BackgroundGradientStops
        {
            get { return (DemoApplication.Styles.GradientStopCollection)GetValue(BackgroundGradientStopsProperty); }
        ...
        public DemoApplication.Styles.GradientStopCollection BorderGradientStops
        {
            get { return (DemoApplication.Styles.GradientStopCollection)GetValue(BorderGradientStopsProperty); }
